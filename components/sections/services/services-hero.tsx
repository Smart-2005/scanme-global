            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  A suite of enterprise SaaS services designed to streamline operations, increase visibility,
                  and support consistent execution across your organization.
                </p>

                <div className="mt-6 flex flex-wrap gap-2">
                  {["Implementation", "Security", "Automation", "Analytics"].map((chip) => (
                    <span
                      key={chip}
                ...
                <div className="rounded-2xl border border-border bg-background/60 p-6 shadow-sm">
                  <div className="flex items-center justify-between">
                    <div className="text-sm">
                      <div className="font-medium text-foreground">Engagement model</div>
                      <div className="text-muted-foreground">Clarity from discovery to delivery</div>
                    </div>
